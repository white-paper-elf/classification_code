...
if __name__ == "__main__":
    ...
    print("-----------------------")
    print("Precision-void = %.4f" % (Precision[0]))
    print("Precision-cup = %.4f" % (Precision[1]))
    print("Precision-liv = %.4f" % (Precision[2]))
    print("m-Precision = %.4f " % ((Precision[0] + Precision[1] + Precision[2]) / 3))
    print("-----------------------")
    print("Recall-void = %.4f" % (Recall[0]))
    print("Recall-cup = %.4f" % (Recall[1]))
    print("Recall-liv = %.4f" % (Recall[2]))
    print("m-Recall = %.4f" % ((Recall[0] + Recall[1] + Recall[2]) / 3))
    print("-----------------------")
    print("F1-void = %.4f" % ((2 * Precision[0] * Recall[0]) / (Precision[0] + Recall[0])))
    print("F1-cup = %.4f" % ((2 * Precision[1] * Recall[1]) / (Precision[1] + Recall[1])))
    print("F1-liv = %.4f" % ((2 * Precision[2] * Recall[2]) / (Precision[2] + Recall[2])))
