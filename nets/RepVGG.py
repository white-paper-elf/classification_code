...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if use_se:
            ...
            self.se = NAMAttention(out_channels)
        else:
            self.se = nn.Identity()
...
def RepVGG_A0(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
...
def RepVGG_A1(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_A2(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[2, 4, 14, 1], num_classes=num_classes,
                  width_multiplier=[1.5, 1.5, 1.5, 2.75], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B0(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B1(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B1g2(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes, use_se=True,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=g2_map, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B1g4(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=g4_map, deploy=deploy, use_checkpoint=use_checkpoint)


def RepVGG_B2(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B2g2(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=g2_map, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B2g4(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=g4_map, deploy=deploy, use_checkpoint=use_checkpoint)


def RepVGG_B3(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[3, 3, 3, 5], override_groups_map=None, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B3g2(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[3, 3, 3, 5], override_groups_map=g2_map, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_B3g4(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=num_classes,
                  width_multiplier=[3, 3, 3, 5], override_groups_map=g4_map, deploy=deploy, use_checkpoint=use_checkpoint)

def RepVGG_D2se(deploy=False, use_checkpoint=False, pretrained=False, progress=True, num_classes=3):
